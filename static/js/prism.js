/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+css-extras&plugins=inline-color+unescaped-markup+normalize-whitespace+toolbar+copy-to-clipboard+match-braces */
    ...
    "undefined" != typeof Prism && "undefined" != typeof document && (Prism.plugins.toolbar ? Prism.plugins.toolbar.registerButton("copy-to-clipboard", (function(e) {
        var o = e.element,
            n = function(t) {
                var e = {
                    copy: "کپی",
                    "copy-error": "Ctrl+C را فشار دهید تا کپی شود",
                    "copy-success": "کپی شد !",
                    "copy-timeout": 5e3
                };
                for (var o in e) {
